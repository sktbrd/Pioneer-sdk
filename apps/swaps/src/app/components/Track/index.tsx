    ...
    content = (
      <Box>
          ...
          <TableContainer>
            <Table size="sm">
              <Thead>
                <Tr>
                  <Th p={1} />
                  {inboundAddresses?.map((chain: any, index: number) => (
              ...
              <Tbody>
                <Tr>
                  <Th p={1}>Scanning</Th>
                  {inboundAddresses?.map((chain: any, index: number) => (
                    <Td key={index} p={2} textAlign="center">
                      {mimir &&
                ...
                <Tr>
                  ...
                  {inboundAddresses?.map((chain: any) => (
                    <Td key={chain.chain} p={2} textAlign="center">
                ...
                {pending
                  ...
                  .map(
                    (row: any) =>
                      row && (
                        <Box
                          key={row.tx_id} // Add key prop with a unique value
                          as="tr"
                          cursor="pointer"
                          fontFamily="mono"
                          onClick={() => {
        ...
        {['Outbound', 'Scheduled'].map((type) => (
          <Card my={3} p={3} variant="outline" width="100%" key={type}>
            <Flex>
              <Center>
                <Heading size="sm">
                  <Text>{type}</Text>
      ...
      <Box>
        {queryLogo && (
          <Flex justifyContent="center" m={6}>
            <Image alt="alt" height={50} src={`/logos/${queryLogo}`} />
          </Flex>
        )}
        <Card p={3} variant="outline">
          <HStack>
          ...
          {activeStep === 3 ? (
            ...
            <div>
              <Image alt="shiftingGif" height={600} src={shiftingGif} width={600} />
            </div>
          )}
