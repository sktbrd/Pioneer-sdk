    ...
    <Stack spacing={4}>
      ...
      <Modal isOpen={isSubmitAddressModalOpen} onClose={() => setIsSubmitAddressModalOpen(false)}>
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            <Text>Please submit the address for {
              // @ts-ignore
            selectedAsset?.name}:</Text>
                ...
                assets.map((asset, index) => (
                  <Box key={index}>
                    ...
                    >
                      <Avatar
                        size="md"
                        src={`https://pioneers.dev/coins/${COIN_MAP_LONG[(asset as any).chain as keyof typeof COIN_MAP_LONG]}.png`}
                      >
