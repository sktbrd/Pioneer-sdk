...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-JLGW7V4P.js";
import {
  ActionBar
} from "./chunk-VOZ4O6G7.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-QWFVNK5I.js";
import {
  require_memoizerific
} from "./chunk-2A36QCY7.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  require_Set,
  ...
  require_toKey,
  str
} from "./chunk-MZDISMG5.js";
import {
  require_Symbol,
  require_isObject,
  require_isObjectLike,
  require_root
} from "./chunk-DEPAGNQG.js";
import {
  O
} from "./chunk-432PNVYY.js";
import {
  require_core_events
} from "./chunk-XYJEXLUH.js";
import {
  esm_default
} from "./chunk-BXJT2TY7.js";
import {
  renderElement,
  unmountElement
} from "./chunk-ZOZG3OML.js";
import {
  require_client_logger
} from "./chunk-OVVIY355.js";
import {
  require_global
} from "./chunk-ZA2RYTVK.js";
import {
  require_preview_api
} from "./chunk-S5RFNMYY.js";
import {
  require_react
} from "./chunk-4QCT4GUW.js";
import {
  __commonJS,
  __toESM
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/default-options.js
var require_default_options = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/default-options.js"(exports, module) {
    module.exports = {
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/build-html.js
var require_build_html = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/build-html.js"(exports, module) {
    module.exports = function(options2) {
      ...
      function updateFixedSidebarClass() {
        ...
        if (top > options2.fixedSidebarOffset) {
          ...
          posFixedEl.className = posFixedEl.className.split(SPACE_CHAR + options2.positionFixedClass).join("");
        }
      }
      ...
      function updateToc(headingsArray) {
        ...
        if (currentlyHighlighting && tocElement !== null && headings.length > 0) {
          ...
          forEach.call(tocLinks, function(tocLink) {
            tocLink.className = tocLink.className.split(SPACE_CHAR + options2.activeLinkClass).join("");
          });
          var tocLis = tocElement.querySelectorAll("." + options2.listItemClass);
          forEach.call(tocLis, function(tocLi) {
            tocLi.className = tocLi.className.split(SPACE_CHAR + options2.activeListItemClass).join("");
          });
          ...
          if (activeTocLink && activeTocLink.nextSibling && activeTocLink.nextSibling.className.indexOf(options2.isCollapsedClass) !== -1) {
            activeTocLink.nextSibling.className = activeTocLink.nextSibling.className.split(SPACE_CHAR + options2.isCollapsedClass).join("");
          }
      ...
      function removeCollapsedFromParents(element) {
        if (element && element.className.indexOf(options2.collapsibleClass) !== -1 && element.className.indexOf(options2.isCollapsedClass) !== -1) {
          element.className = element.className.split(SPACE_CHAR + options2.isCollapsedClass).join("");
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/parse-content.js
var require_parse_content = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/parse-content.js"(exports, module) {
    module.exports = function parseContent(options2) {
      ...
      function getHeadingObject(heading) {
        ...
        const headingLabel = heading.getAttribute("data-heading-label") || (options2.headingLabelCallback ? String(options2.headingLabelCallback(heading.textContent)) : heading.textContent.trim());
        var obj = {
          id: heading.id,
          children: [],
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/update-toc-scroll.js
var require_update_toc_scroll = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/update-toc-scroll.js"(exports, module) {
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/scroll-smooth/index.js
var require_scroll_smooth = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/scroll-smooth/index.js"(exports) {
...
// ../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/index.js
var require_js = __commonJS({
  "../../node_modules/.pnpm/tocbot@4.21.1/node_modules/tocbot/src/js/index.js"(exports, module) {
...
// ../../node_modules/.pnpm/@storybook+blocks@7.6.17_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/blocks/dist/index.mjs
...
// ../../node_modules/.pnpm/@babel+runtime@7.23.7/node_modules/@babel/runtime/helpers/esm/inheritsLoose.js
...
// ../../node_modules/.pnpm/@babel+runtime@7.23.7/node_modules/@babel/runtime/helpers/esm/isNativeFunction.js
...
// ../../node_modules/.pnpm/@babel+runtime@7.23.7/node_modules/@babel/runtime/helpers/esm/construct.js
...
// ../../node_modules/.pnpm/@babel+runtime@7.23.7/node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-7RJYSJX3.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-27DPRYSI.js"));
...
// ../../node_modules/.pnpm/@storybook+addon-docs@7.6.17_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-6U6ALWO2.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GSM2UB2H.js.map
