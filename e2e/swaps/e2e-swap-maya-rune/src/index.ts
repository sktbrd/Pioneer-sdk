...
let BLOCKCHAIN_IN = ChainToNetworkId['MAYA']
let BLOCKCHAIN_OUT = ChainToNetworkId['THOR']
let ASSET = 'MAYA'
let MIN_BALANCE = process.env['MIN_BALANCE_MAYA'] || "0.01"
let TEST_AMOUNT = process.env['TEST_AMOUNT'] || "25"
let spec = process.env['VITE_PIONEER_URL_SPEC'] || 'https://pioneers.dev/spec/swagger.json'
let wss = process.env['URL_PIONEER_SOCKET'] || 'wss://pioneers.dev'

let TRADE_PAIR  = "MAYA_THOR"
...
const test_service = async function (this: any) {
    ...
    try {
        ...
        let balance = app.balances.filter((e:any) => e.chain === ASSET)
